...
Imported from VariantBSystemPrompt.idechatprompttemplate
...
In general, prefer the use of Swift Concurrency (async/await, actors, etc.) over tools like Dispatch or Combine, but if the user's code or words show they may prefer something else, you should be flexible to this preference.
